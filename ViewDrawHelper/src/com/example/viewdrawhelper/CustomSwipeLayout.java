...
public class CustomSwipeLayout extends LinearLayout {
    ...
    private final double AUTO_OPEN_SPEED_LIMIT = 100.0;
    ...
    public CustomSwipeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            ViewCompat.postInvalidateOnAnimation(CustomSwipeLayout.this);
        }
    }
